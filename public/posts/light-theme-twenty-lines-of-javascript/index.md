...
description: "I added a theme toggle to the site. You can now switch between the dark theme, which has been the default since forever, and a light one with a vaporwave aesthetic: warm cream background, dark teal accents, readable blue on paper.\nBefore you picture me pulling in a bunch of dependencies: no. There’s no React, no Alpine.js, nothing that needed npm install. It’s literally fewer than twenty lines of vanilla JavaScript, split into two parts.\n"
url: "https://adlermedrado.com.br/posts/light-theme-twenty-lines-of-javascript/"
