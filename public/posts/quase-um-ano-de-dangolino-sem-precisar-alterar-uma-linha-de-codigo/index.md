...
description: "Já faz algum tempo que eu postei aqui que eu estava usando o picasaweb para publicar as imagens no meu blog usando o dangolino, mas, recentemente eu pensei melhor e decidi que quero manter as imagens no meu próprio servidor.\nOs motivos são vários, mas o principal é que quero manter a integridade do meu conteúdo em único local, neste caso o meu servidor, simplesmente pela facilidade que tenho de fazer backup dele, que é muito mais fácil para mim do que manter um backup de serviços como o picasaweb ou o flickr por exemplo.\n"
url: "https://adlermedrado.com.br/posts/quase-um-ano-de-dangolino-sem-precisar-alterar-uma-linha-de-codigo/"
